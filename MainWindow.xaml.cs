...
public sealed partial class MainWindow : Window {
    ...
    private void PlayArea_KeyDown(object sender, KeyRoutedEventArgs e) {
        switch (e.Key) {
            case Windows.System.VirtualKey.Left: _x -= Speed; break;
            case Windows.System.VirtualKey.Right: _x += Speed; break;
            case Windows.System.VirtualKey.Up: _y -= Speed; break;
            case Windows.System.VirtualKey.Down: _y += Speed; break;
        }
